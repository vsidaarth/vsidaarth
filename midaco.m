...
function [ solution ] = midaco( problem, option, key, h ) %%sometimes use function [ solution ] = midaco( problem, option, key, h )
...
%       [ f, g ] = problem.func( x, h ); %%%sometimes include h sometimes not
      [ f, g ] = problem.func( x );
